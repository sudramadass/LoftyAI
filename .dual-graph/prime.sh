#!/usr/bin/env bash
PORT=$(cat "/Users/sidramadass/Desktop/LoftyAI/.dual-graph/mcp_port" 2>/dev/null || echo 8080)
...
if [[ -f "/Users/sidramadass/Desktop/LoftyAI/CONTEXT.md" ]]; then
  echo ""
  echo "=== CONTEXT.md ==="
  cat "/Users/sidramadass/Desktop/LoftyAI/CONTEXT.md"
  echo "=== end CONTEXT.md ==="
fi
# Inject context store entries (decisions, tasks, next steps) — max 15 lines, 7-day window
STORE="/Users/sidramadass/Desktop/LoftyAI/.dual-graph/context-store.json"
